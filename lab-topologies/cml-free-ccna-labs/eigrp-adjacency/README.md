...
In CML choose **Lab > Import** and pick `eigrp-adjacency.yaml`, or use **Add Lab from Repository** if you have this
...
- Import `eigrp-adjacency.yaml`, then configure the devices yourself — the starter topology is deliberately unconfigured.
