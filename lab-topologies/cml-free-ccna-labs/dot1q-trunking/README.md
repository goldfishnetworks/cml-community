...
In CML choose **Lab > Import** and pick `dot1q-trunking.yaml`, or use **Add Lab from Repository** if you have this
...
- Import `dot1q-trunking.yaml`, then configure the devices yourself — the starter topology is deliberately unconfigured.
