...
In CML choose **Lab > Import** and pick `ssh-access.yaml`, or use **Add Lab from Repository** if you have this
...
- Import `ssh-access.yaml`, then configure the devices yourself — the starter topology is deliberately unconfigured.
