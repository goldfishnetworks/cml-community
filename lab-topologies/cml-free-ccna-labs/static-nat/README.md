...
In CML choose **Lab > Import** and pick `static-nat.yaml`, or use **Add Lab from Repository** if you have this
...
- Import `static-nat.yaml`, then configure the devices yourself — the starter topology is deliberately unconfigured.
