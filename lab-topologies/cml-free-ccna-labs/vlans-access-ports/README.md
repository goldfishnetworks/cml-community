...
In CML choose **Lab > Import** and pick `vlans-access-ports.yaml`, or use **Add Lab from Repository** if you have this
...
- Import `vlans-access-ports.yaml`, then configure the devices yourself — the starter topology is deliberately unconfigured.
